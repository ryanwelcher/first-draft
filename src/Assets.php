...
class Assets {
	...
	public function boot(): void {
		// Editor styles.
		add_action( 'after_setup_theme', array( $this, 'addEditorStyles' ) );

				// Front-end only.
				add_action( 'wp_enqueue_scripts', array( $this, 'enqueueAssets' ) );

				// Enqueue block-specific styles.
				add_action( 'init', array( $this, 'enqueueBlockStyles' ) );
	...
	public function addEditorStyles(): void {
			add_editor_style(
				array(
					get_parent_theme_file_uri( 'build/styles.css' ),
				)
			);
	}
	...
	public function enqueueAssets(): void {
		...
		$assets_file_path = get_parent_theme_file_path( 'build/styles.asset.php' );

		if ( file_exists( $assets_file_path ) ) {
			$assets_file = include $assets_file_path;
			// Enqueue the primary `style.css` file.
			wp_enqueue_style(
				'first-draft-style',
				get_parent_theme_file_uri( 'build/styles.css' ),
				null,
